...
You can download the CU2025 Dataset using the link provided in CU2025_PCAP.txt.
...
To combine the PCAP files for a device into a single PCAP file, you can use:

combine code.py


This script combines the individual PCAP files and generates a single output file named:
...
This can be useful for machine learning and classification tasks where each network traffic record needs to be associated with its corresponding device.
